(function() {
    ...
    const ASSETS = {
        css: [
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/style/index.vsb.css',
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/style/index.css',
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/swiper/swiper.min.css',   
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/swiper/swiper-bundle.min.css',
            { url: 'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/style/phone.css', media: 'screen and (max-width: 800px)' }
        ],
        js: [
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/jquery.min.js', 
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/TweenMax.min.js',
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/set.js', 
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/js.js', 
            'https://cdn.jsdelivr.net/gh/w0kid/xdxy-wlzx/script/swiper/swiper.jquery.min.js',
    ...
    async function init() {
        ...
        if (config && config.enableProtection === true) {
            ...
            // 4. 【核心修改】先让页面显示出来，DOM 元素获得真实的宽高
            clearTimeout(failSafe);
            root.style.display = ''; 

            // 5. 【核心修改】页面显示后，再执行 jQuery 缓存的 ready 函数（此时 Swiper 就能正常初始化了）
